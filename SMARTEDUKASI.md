# www.smartedukasi.co.id - an example deployment
...
Create the `nginx/default.conf` file by copying the contents of `default_https.conf.template` and replacing **FQDN\_OR\_IP** with **smartedukasi.co.id**
